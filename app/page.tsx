...
function normalizeProduct(v: string) {
  const t = (v || '').trim()
  if (!t) return 'Unknown'
  if (t.toLowerCase().includes('optom')) return ' Optics'
  if (t.toLowerCase() === 'meds') return ' Meds'
